...
%Explanation of why $SOL$ might not be in $\NP$: Suppose $p$ is a polynomial with degree $> 5$. We know that $p$ does not have algebraic roots in general. Therefore, given a set of real numbers $a_1,\dots,a_n$, we cannot verify whether it is a root of $p$ in polynomial time.
